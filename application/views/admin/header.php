...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>assets/backend/dist/css/skins/all-md-skins.min.css">
  <!-- Morris chart -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg">E_commerce</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>assets/backend/dist/img/user-160x160.jpg" class="user-image" alt="User Image">
