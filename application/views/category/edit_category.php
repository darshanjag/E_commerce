  ...
  <?php if($this->session->flashdata('error')!=''){ echo '<div class="alert alert-danger">'.$this->session->flashdata('error').'</div>'; } ?>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="category_name" name="category_name" placeholder="Category Name" value="<?= $category[0]->category_name; ?>">
                  </div>
...
<option value="1" <?php if($category[0]->category_status==1){ echo 'selected'; }?>>Active</option>
<option value="0" <?php if($category[0]->category_status==0){ echo 'selected'; }?>>Inactive</option>
</select>
                  </div>
